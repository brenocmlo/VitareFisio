...
- **🏛️ Arquitetura Multi-Tenant:** Isolamento de dados através de `clinica_id`. Fisioterapeutas autônomos recebem uma "clínica virtual" automática no cadastro, garantindo a mesma escalabilidade de grandes clínicas.
